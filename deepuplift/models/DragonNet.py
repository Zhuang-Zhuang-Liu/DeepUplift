...
def dragonnet_loss( t_pred, y_preds,t_true,y_true, alpha=1.0):
    """
...
def tarreg_loss( t_pred, y_preds,t_true,y_true,eps,  alpha=1.0, beta=1.0):
    """
    ...
    loss: torch.Tensor
    """
    vanilla_loss,loss0,loss1,loss_t = dragonnet_loss( t_pred, y_preds, t_true,y_true,alpha)
